        ...
        <div class="menu-grid" id="menuGrid">
            ...
            @foreach($menuItems as $item)
                <div class="card">
                    ...
                    <a href="https://api.whatsapp.com/send/?phone=%2B6285604030757&text=Halo%2C+saya+tertarik+dengan+produk+Anda&type=phone_number&app_absent=0" target="_blank" class="btn">Pesan Sekarang</a>
                </div>
            @endforeach
        </div>
    </section>
